...
// CORRIGIDO: checkSession real + re-login automático
// =============================================
...
class SigmaSession {
  ...
  // =============================================
  // CHECK SESSION (REAL - faz requisição ao servidor!)
  // =============================================
  async checkSession() {
    if (!this.authToken) {
    ...
    try {
      // Fazer uma requisição real para verificar se token funciona
      // GET /api/me ou /api/user são endpoints comuns em APIs
      const response = await this.request('GET', '/api/me', null, {}, true);
